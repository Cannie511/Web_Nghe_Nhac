...
// Lưu lại URL hiện tại vào biến session
    ...
    <div class="container-fluid">
        <div class="col-sm-4">
            <div id="menu">
                ...
                <div id="menu_cover">
                    <div class="menu_item init" onclick="loadContent('./component/Playlist.php')" id="home">
                    ...
                    <div class="col-md-4 menu_item" onclick="loadContent('./component/BangXepHang.php')" id="bxh">
                        <ion-icon name="bar-chart-outline">
                        </ion-icon><span>BẢNG XẾP HẠNG</span>
                    </div>
        ...
        <div class="col-sm-7">
            <div id="main_play">
                ...
                <div id="topMenu">
                    ...
                    <div id="search" class="col-sm-4">
                        <ion-icon name="chevron-back-circle" style="margin-left: 10px;"
                            id="backTab"></ion-icon>
                ...
                <div id='contentContainer'>
                    <?php include './component/Playlist.php' ?>
                </div>
            ...
            <audio controls style='opacity:0' id='music'>
                <source
                    src="https://vnso-pt-24-tf-a128-zmp3.zmdcdn.me/966012e4e868f2efc96237dedc1145af?authen=exp=1702026755~acl=/966012e4e868f2efc96237dedc1145af/*~hmac=082a75cb29b93bf5b0684f81ff20e085" />
            </audio>
        </div>
</body>
...
<script>
    ...
    idPL.forEach(function (div) {
        div.addEventListener('click', function () {
            var idPlaylist = this.id;
            console.log('idPlaylist:', idPlaylist);
            document.cookie = "idPL=" + encodeURIComponent(idPlaylist) + "; path=/";
            // location.reload();
        });
    });
    function loadContent(page) {
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                // Đưa nội dung trả về vào div.main
    ...
    function goBack() {
        // Sử dụng JavaScript để back lại trang trước đó
