    ...
    <form action="xuly.php" id="0" method="post">
      ...
      <div class="row row-cols-2 ">
        ...
        <div class="col info">
          ...
          <input type="Date" class="form-control" id="floatingInput" name="birth_user" placeholder="name@example.com">
          ...
          <div class="form-floating mb-3">
            <input type="password" class="form-control" id="floatingPassword" name="retype_pass_user"
